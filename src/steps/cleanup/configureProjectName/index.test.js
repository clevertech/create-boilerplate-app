...
describe('Base configuration of project name', () => {
  ...
  test.todo('configures project name in docker/run script')
  ...
  test.todo(
    'configures description in sub-folders.  i.e. Clevertech API, Clevertech Frontend, Clevertech (in root package.json)'
  )
  test.todo(
